...
// 1. 현재 날짜/시간
let today = new Date();
console.log(today);                 // 2023-03-21T00:16:26.447Z
console.log(today.toDateString());  // Tue Mar 21 2023
console.log(today.toLocaleString());    // Timezone 반영됨, 2023. 3. 21. 오전 9:18:59
...
// 4. 날짜/시간 요소 기반
let elementDay = new Date(2023, 2, 21, 9, 30);      // 시간 단위를 생략하면 0 으로 대체됨
